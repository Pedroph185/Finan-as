@'
# 💰 Finan-as — Dashboard de Finanças Pessoais
...
* **Análise de Gastos:** Divisão automática por categorias (alimentação, transporte, lazer, etc.).
* **Fácil Integração:** Leitura automatizada de planilhas de dados (`dashboard.xlsx`).

## 🛠️ Tecnologias Utilizadas
* **Python** (Linguagem principal)
* **Pandas** (Tratamento e análise de dados)
* **Excel / Openpyxl** (Armazenamento local de dados)
* *(Opcional)* **Streamlit / Flask / Dash** (Interface do Dashboard)
